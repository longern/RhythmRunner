...
VOID RenderWelcome(HDC hdcBmp)
{
	...
	TextOut(hdcBuffer, ToWindowX(0.4), ToWindowY(0.43), _T("Play"), 4);
	TextOut(hdcBuffer, ToWindowX(0.4), ToWindowY(0.48), _T("Options"), 7);
	TextOut(hdcBuffer, ToWindowX(0.4), ToWindowY(0.53), _T("Exit"), 4);
}
